...
if selected_tab == "Reporting":
    ...
    if user_input:
        ...
        # First attempt: keyword-based response
        assistant_reply = handle_simple_prompt(user_input, kpis)
        ...
        with st.chat_message("assistant"):
            with st.spinner("Thinking..."):
                if assistant_reply:
                    ...
                    try:
                        messages = [{"role": "system", "content": COACH_STYLE + "\n\n" + str(kpis)}] + st.session_state.chat_history
